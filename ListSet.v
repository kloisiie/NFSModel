...
Lemma Set_removeSub : forall (B : set) (x : A), ~ set_In x (set_remove x B). 
intro; intro. 
...
Qed.
  ...
  Hint Resolve set_add_intro1 set_add_intro2 Set_removeSub. 
  ...
  Proof. 
    ...
    generalize (set_mem_completeSub (a:=a) (x:=y)). 
  ...
  Proof. 
    ...
    rewrite Ha0a; generalize (set_mem_completeObj Hay). 
    elim (set_mem a y);
